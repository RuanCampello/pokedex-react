  ...
  <RecoilRoot>
    <div className='space-y-4'>
      ...
      <form onSubmit={handleSubmit} className='flex sm:relative absolute sm:w-full w-80 mx-auto sm:left-0 sm:bottom-0 bottom-4 left-0 right-0' >
        <input onChange={e => setQuery(e.target.value)} className='sm:w-full rounded-l-xl h-12 text-lg text-slate-800 p-3 focus:outline-none border-r-0 border-4 border-slate-800 sm:border-platinum focus:border-slate-400' placeholder='name or id' type="text" />
